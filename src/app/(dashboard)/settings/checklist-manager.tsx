        ...
        <Table className="text-xs">
          <TableHeader className="bg-slate-800">
            <TableRow className="hover:bg-transparent border-none">
              <TableHead className="w-[60px] font-black text-slate-300 border-r border-slate-700/50 text-center h-8 text-[13px] uppercase tracking-wider px-4">#</TableHead>
              <TableHead className="w-[150px] font-black text-slate-300 border-r border-slate-700/50 text-center h-8 text-[13px] uppercase tracking-wider px-4">카테고리</TableHead>
              <TableHead className="w-[200px] font-black text-slate-300 border-r border-slate-700/50 h-8 text-[13px] uppercase tracking-wider px-4">점검 항목명</TableHead>
              <TableHead className="w-[120px] font-black text-slate-300 border-r border-slate-700/50 text-center h-8 text-[13px] uppercase tracking-wider px-4">대상/값</TableHead>
              <TableHead className="font-black text-slate-300 border-r border-slate-700/50 h-8 text-[13px] uppercase tracking-wider px-4">세부 내용 / 기준</TableHead>
              <TableHead className="w-[100px] font-black text-slate-300 border-r border-slate-700/50 text-center h-8 text-[13px] uppercase tracking-wider px-4">수기입력</TableHead>
              <TableHead className="w-[120px] font-black text-slate-300 text-center h-8 text-[13px] uppercase tracking-wider px-4">관리</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
